  ...
  'es-MX': {
    ...
    services: {
      ...
      'software development': {
        ...
        benefits: {
          0: 'Personalizado a tus requerimientos',
      ...
      'it consulting': {
        ...
        desc: 'Guía estratégica para optimizar tus operaciones y transformación digital.',
        benefits: {
          0: 'Planificación tecnológica',
          1: 'Optimización de procesos',
          2: 'Transformación digital',
          3: 'Soluciones costo-efectivas'
        }
      },
      'software engineering training': {
        title: 'Capacitación en Ingeniería de Software',
        desc: 'Programas de formación para potenciar a tu equipo.',
        benefits: {
    ...
    footer: {
        ...
        legal: {
          ...
          links: {
            privacy: {
              ...
              'en-EU': 'Privacy Policy'
            },
            terms: {
              'es-MX': 'Términos de Servicio',
              'en-EU': 'Terms of Service'
            },
            cookies: {
              'es-MX': 'Política de Cookies',
              'en-EU': 'Cookie Policy'
            }
          }
        }
      ...
      copyright: {
        'es-MX': 'Todos los derechos reservados.',
        'en-EU': 'All rights reserved.'
      },
      madeWith: {
        'es-MX': 'Hecho con ❤️ en México',
        'en-EU': 'Made with ❤️ in Mexico'
      }
    },
    backToTop: {
      label: {
  ...
  'en-EU': {
    ...
    services: {
      ...
      'software development': {
        ...
        desc: 'Custom solutions tailored to your business needs and challenges.',
        benefits: {
          0: 'Tailored to your requirements',
      ...
      'it consulting': {
        title: 'IT Consulting',
        desc: 'Strategic guidance to optimize your operations and digital transformation.',
        benefits: {
          0: 'Technology roadmap planning',
      ...
      'software engineering training': {
        ...
        desc: 'Training programs to upskill your team.',
        benefits: {
